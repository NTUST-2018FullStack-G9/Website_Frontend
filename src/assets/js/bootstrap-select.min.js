...
!(function(a) {
    ...
    (f.prototype = {
        ...
        var e = this.options.hideDisabled ? ":not([disabled])" : "",
          f = this.$element
            ...
            .map(function() {
              ...
              return (
                (b = c.options.showSubtext && d.attr("data-subtext") && !c.multiple ? ' <small class="muted text-muted">' + d.data("subtext") + "</small>" : ""),
        ...
        if ((r(), this.options.header && f.css("padding-top", 0), "auto" == this.options.size)) {
          var s = function() {
            ...
            r(),
              ...
              (a = h.length + h.filter(".dropdown-header").length > 3 ? 3 * i + q - 2 : 0),
              f.css({ "max-height": b + "px", overflow: "hidden", "min-height": a + j + k + l + "px" }),
              g.css({ "max-height": b - j - k - l - n + "px", "overflow-y": "auto", "min-height": Math.max(a - n, 0) + "px" });
          };
          s(),
      ...
      checkDisabled: function() {
        ...
        this.isDisabled()
          ...
          : (this.$button.hasClass("disabled") && this.$button.removeClass("disabled"), -1 == this.$button.attr("tabindex") && (this.$element.data("tabindex") || this.$button.removeAttr("tabindex"))),
      ...
      liveSearchListener: function() {
        ...
        this.$newElement.on("click.dropdown.data-api touchstart.dropdown.data-api", function() {
          b.$menu.find(".active").removeClass("active"),
            b.$searchbox.val() && (b.$searchbox.val(""), b.$lis.not(".is-hidden").removeClass("hide"), e.parent().length && e.remove()),
            ...
            b.$searchbox.val()
              ? (b.options.searchAccentInsensitive
                ...
                b.$menu.find("li").filter(":visible:not(.no-results)").length
                  ...
                  : (e.parent().length && e.remove(),
                    e.html(b.options.noneResultsText + ' "' + d(b.$searchbox.val()) + '"').show(),
                    b.$menu
                      .find("li")
                      .last()
                      .after(e)))
              : (b.$lis.not(".is-hidden").removeClass("hide"), e.parent().length && e.remove()),
      ...
      keydown: function(b) {
        ...
        if (
          ...
          o.options.liveSearch &&
            (/(^9$|27)/.test(b.keyCode.toString(10)) && l && 0 === o.$menu.find(".active").length && (b.preventDefault(), o.$menu.parent().removeClass("open"), o.$button.focus()),
            (d = a("[role=menu] li:not(.divider):not(.dropdown-header):visible", n)),
            m.val() ||
              /(38|40)/.test(b.keyCode.toString(10)) ||
              (0 === d.filter(".active").length &&
                (d = o.$newElement.find("li").filter(o.options.searchAccentInsensitive ? ":aicontains(" + c(p[b.keyCode]) + ")" : ":icontains(" + p[b.keyCode] + ")")))),
          d.length)
        ) {
          if (/(38|40)/.test(b.keyCode.toString(10)))
            (e = d.index(d.filter(":focus"))),
              ...
              o.options.liveSearch &&
                ...
                (j = d
                  ...
                  .data("index"))),
              (k = m.data("prevIndex")),
              38 == b.keyCode && (o.options.liveSearch && (e -= 1), e != j && e > i && (e = i), g > e && (e = g), e == k && (e = h)),
              40 == b.keyCode && (o.options.liveSearch && (e += 1), -1 == e && (e = 0), e != j && f > e && (e = f), e > h && (e = h), e == k && (e = g)),
              m.data("prevIndex", e),
              o.options.liveSearch
                ? (b.preventDefault(),
            ...
            d.each(function() {
              ...
              (r = a
                ...
                .substring(0, 1)),
              r != p[b.keyCode] ? ((q = 1), a(document).data("keycount", q)) : q >= s.length && (a(document).data("keycount", 0), q > s.length && (q = 1)),
              d.eq(s[q - 1]).focus();
          }
          (/(13|32)/.test(b.keyCode.toString(10)) || (/(^9$)/.test(b.keyCode.toString(10)) && o.options.selectOnTab)) &&
            l &&
            (/(32)/.test(b.keyCode.toString(10)) || b.preventDefault(),
            o.options.liveSearch ? /(32)/.test(b.keyCode.toString(10)) || (o.$menu.find(".active a").click(), m.focus()) : a(":focus").click(),
            a(document).data("keycount", 0)),
            ((/(^9$|27)/.test(b.keyCode.toString(10)) && l && (o.multiple || o.options.liveSearch)) || (/(27)/.test(b.keyCode.toString(10)) && !l)) &&
  ...
  (a.fn.selectpicker = e),
    ...
    a(document)
      .data("keycount", 0)
      .on("keydown", ".bootstrap-select [data-toggle=dropdown], .bootstrap-select [role=menu], .bs-searchbox input", f.prototype.keydown)
